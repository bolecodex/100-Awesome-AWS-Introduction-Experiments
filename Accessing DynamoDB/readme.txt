...
aws dynamodb update-item --table-name Notes --key '{"UserId": {"S": "StudentD"}, "NoteId": {"N": "42"}}' --update-expression "SET Notes = :newnote" --condition-expression "Favorite NOT yes" --expression-attribute-values '{":newnote":{"S":"Amazon DynamoDB is a …"}}'

aws dynamodb delete-item --table-name Notes --key '{"UserId": {"S": "StudentD"}, "NoteId": {"N": "42"}}'

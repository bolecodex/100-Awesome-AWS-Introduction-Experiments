...
public class HitCounterTest {
    ...
    public void testDynamoDBTable() throws Exception {
        ...
        // Typically used, as part of unit tests, to validate that the rendered CloudFormation
        // template has expected resources and properties.
        Template template = Template.fromStack(stack);
        // resourceCountIs: Assert that the given number of resources of the given type exist in the template.
    ...
    @Test
    public void testDynamoDBRaises() throws Exception {
        Stack stack = new Stack();
